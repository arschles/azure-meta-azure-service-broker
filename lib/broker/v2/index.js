...
var BrokerV2 = function(opts) {
  ...
  // this.db.updateSQLcredentials(opts.accountPool.sqldb);
...
BrokerV2.prototype.start = function() {
  ...
  //   async.apply(server.listen, broker.opts.port),
  //     server.listen(broker.opts.port, callback);
  //   },
